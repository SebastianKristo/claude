...
Repoene `ki-*` er ikke endret.

## Installasjon

1. Kopier `dist/ki-hjem-design.js` til `/config/www/ki-hjem-design.js`.
2. *Innstillinger → Dashbord → ⋮ → Ressurser → Legg til*: `/local/ki-hjem-design.js`, type **JavaScript-modul**.
...
4. Hard-refresh appen/nettleseren.
